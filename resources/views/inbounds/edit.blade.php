            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="status" class="form-control" {{ $lockTotal ? 'disabled' : '' }}>
                        <option value="draft" {{ $inbound->status === 'draft' ? 'selected' : '' }}>
                            Draft
                        </option>
                        <option value="need_approved" {{ $inbound->status === 'need_approved' ? 'selected' : '' }}>
                            Need Approved
                        </option>
                        <option value="approved" {{ $inbound->status === 'approved' ? 'selected' : '' }}>
                            Approved
                        </option>
                        <option value="expired" {{ $inbound->status === 'expired' ? 'selected' : '' }}>
                            Expired
                        </option>
                    </select>
                </div>
